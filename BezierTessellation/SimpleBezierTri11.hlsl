...
{    
    ...
    Output.Inside[0] = g_fTessellationFactor;
    return Output;
}
...
HS_OUTPUT BezierTriHS( InputPatch<VS_CONTROL_POINT_OUTPUT, INPUT_PATCH_SIZE> p, 
...
[domain("tri")]
DS_OUTPUT BezierTriDS( HS_CONSTANT_DATA_OUTPUT input, 
